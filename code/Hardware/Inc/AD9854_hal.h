...
#define AD9854_RD_SET (HAL_GPIO_WritePin( GPIOC, GPIO_PIN_0, GPIO_PIN_SET))
#define AD9854_RD_CLR (HAL_GPIO_WritePin( GPIOC, GPIO_PIN_0, GPIO_PIN_RESET))

#define AD9854_WR_SET (HAL_GPIO_WritePin( GPIOC, GPIO_PIN_1, GPIO_PIN_SET))
#define AD9854_WR_CLR (HAL_GPIO_WritePin( GPIOC, GPIO_PIN_1, GPIO_PIN_RESET))

#define AD9854_UDCLK_SET (HAL_GPIO_WritePin( GPIOC, GPIO_PIN_2, GPIO_PIN_SET))
#define AD9854_UDCLK_CLR (HAL_GPIO_WritePin( GPIOC, GPIO_PIN_2, GPIO_PIN_RESET))

#define AD9854_RST_SET (HAL_GPIO_WritePin( GPIOC, GPIO_PIN_3, GPIO_PIN_SET))
#define AD9854_RST_CLR (HAL_GPIO_WritePin( GPIOC, GPIO_PIN_3, GPIO_PIN_RESET))

#define AD9854_SP_SET (HAL_GPIO_WritePin( GPIOC, GPIO_PIN_4, GPIO_PIN_SET))
#define AD9854_SP_CLR (HAL_GPIO_WritePin( GPIOC, GPIO_PIN_4, GPIO_PIN_RESET))

#define AD9854_OSK_SET (HAL_GPIO_WritePin( GPIOC, GPIO_PIN_5, GPIO_PIN_SET))
#define AD9854_OSK_CLR (HAL_GPIO_WritePin( GPIOC, GPIO_PIN_5, GPIO_PIN_RESET))

#define AD9854_FDATA_SET (HAL_GPIO_WritePin( GPIOC, GPIO_PIN_6, GPIO_PIN_SET))
#define AD9854_FDATA_CLR (HAL_GPIO_WritePin( GPIOC, GPIO_PIN_6, GPIO_PIN_RESET))
...
#define SPI_IO_RST_SET (HAL_GPIO_WritePin( GPIOB, GPIO_PIN_13, GPIO_PIN_SET))
#define SPI_IO_RST_CLR (HAL_GPIO_WritePin( GPIOB, GPIO_PIN_13, GPIO_PIN_RESET))
#define SPI_SDO_Set (HAL_GPIO_WritePin( GPIOB, GPIO_PIN_14, GPIO_PIN_SET))
#define SPI_SDO_Clr (HAL_GPIO_WritePin( GPIOB, GPIO_PIN_14, GPIO_PIN_RESET))
#define SPI_SDI_Set (HAL_GPIO_WritePin( GPIOB, GPIO_PIN_15, GPIO_PIN_SET))
#define SPI_SDI_Clr (HAL_GPIO_WritePin( GPIOB, GPIO_PIN_15, GPIO_PIN_RESET))
